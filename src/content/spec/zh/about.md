...
中文入口是 [/zh/](/zh/)，英文入口是 [/en/](/en/)。两种语言的文章与搜索结果分别组织，译文需要单独撰写。具体写作和部署方法记录在仓库的[写作指南](https://github.com/xw7qwq/nfuwari/blob/main/docs/WRITING.md)与[部署指南](https://github.com/xw7qwq/nfuwari/blob/main/docs/DEPLOYMENT.md)中。
